...
export default function CompetitorsPage({
  ...
  async function handleAdd(data: CompetitorFormData) {
    ...
    const competitor: Competitor = {
      ...
      ...((): { alternativeSailNumbers?: string[] } => {
        const alts = parseAlternativeSailNumbers(data.alternativeSailNumbers);
        return alts.length ? { alternativeSailNumbers: alts } : {};
      })(),
  ...
  async function handleEdit(data: CompetitorFormData) {
    ...
    if (!parseAlternativeSailNumbers(data.alternativeSailNumbers).length) {
      delete updated.alternativeSailNumbers;
    }
  ...
  const showTallyNumber = enabledFields.includes('tallyNumber');
  ...
  const sortColumns: SortableColumn<Competitor>[] = [
    ...
    ...(showAlternatives
      ? [col('alternativeSailNumbers', (a, b) =>
          compareText(
            formatAlternativeSailNumbers(a.alternativeSailNumbers),
    ...
    ...(showEntryNumber
      ...
      : []),
    ...(showTallyNumber
      ? [col('tallyNumber', (a, b) => compareSailNumbers(a.tallyNumber ?? '', b.tallyNumber ?? ''))]
      : []),
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              {showTallyNumber && <SortableTableHead columnId="tallyNumber" sortKeys={sortKeys} onSort={handleSort}>Tally</SortableTableHead>}
          ...
          <TableBody ref={tbodyRef}>
            {sortedCompetitors.map((c) => (
              ...
              >
                ...
                {showTallyNumber && <TableCell className="font-mono">{c.tallyNumber ?? ''}</TableCell>}
          ...
          {editingCompetitor && (
            <CompetitorForm
              ...
              initial={{
                ...
                alternativeSailNumbers: formatAlternativeSailNumbers(
                  editingCompetitor.alternativeSailNumbers,
                ),
                entryNumber: editingCompetitor.entryNumber ?? '',
                tallyNumber: editingCompetitor.tallyNumber ?? '',
