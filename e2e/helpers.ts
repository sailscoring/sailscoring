...
export async function addCompetitor(
  page: Page,
  data: { sailNumber: string; name: string; boatClass?: string; crew?: string; club?: string; fleet?: string; ircTcc?: string; pyNumber?: string; nhcStartingTcf?: string; echoStartingTcf?: string },
): Promise<void> {
  ...
  if (data.boatClass) await page.getByLabel('Class', { exact: true }).fill(data.boatClass);
