...
- ADR-010: As-published archives (Proposed — historical results become a second, display-only series regime: ingested as published via per-class archive repos + CI, never re-scored; identity manifest-pinned; replaces the reconstruction/parity approach for pre-2026 corpora)
