...
- **License:** MIT, copyright Mark McLoughlin — the open-source vs. commercial question was decided in favour of open source in July 2026 (#282; see `docs/goals.md`). The repo goes public once the #282 pre-flip checklist is done. Dependency policy unchanged: avoid copyleft (GPL) libraries — the codebase must remain distributable under MIT; prefer MIT, Apache 2.0, or BSD. The "Sail Scoring" name and logo are trademarks, not covered by the code license.
