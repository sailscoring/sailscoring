...
[`prototype.md`](prototype.md) for the demo setup,
findings, and shortcut list; the design lives in
`docs/design/split-fleets.md` and
...
![Empty phase stack](walkthrough/02-empty-phases.png)
...
![Create Round 1 dialog](walkthrough/03-seed-round-1.png)
...
![Round 1 card](walkthrough/04-round-1-created.png)
...
![Both races counting](walkthrough/05-q1-q2-counting.png)
...
![Assign Round 2 dialog](walkthrough/06-assign-round-2.png)
...
![Two round cards](walkthrough/07-round-2-created.png)
...
![Standings with cut line](walkthrough/08-cut-line.png)
...
![Split dialog](walkthrough/09-split-dialog.png)
...
![Final fleets with F1](walkthrough/10-final-fleets-f1.png)
...
![F1 and F2 ticked](walkthrough/11-f1-f2-complete.png)
...
![Medal round committed](walkthrough/12-medal-round.png)
...
![Gold standings with medal column](walkthrough/13-medal-standings.png)
...
![Revision history](walkthrough/14-history.png)
