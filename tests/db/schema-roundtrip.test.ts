...
describe.skipIf(skip)('schema round-trip', () => {
  ...
  test('round-trips a fully-populated series with every child resource', async () => {
    ...
    const seriesRow: Series = {
      ...
      snapshotHistory: [uuid(), uuid(), uuid()],
    ...
    const competitor: Competitor = {
      ...
      name: 'Helm McHelmington',
      owner: 'Owner O\'Owner',
      helm: 'Helm McHelmington',
      crewName: 'Crew',
      club: 'HYC',
      gender: 'M',
      age: 42,
    ...
    await db.insert(schema.competitors).values({
      ...
      helm: competitor.helm,
      crewName: competitor.crewName,
